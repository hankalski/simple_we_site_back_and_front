							...
							<div class="tg-userbox">
								...
								<div class="dropdown tg-dropdown">
									...
									<ul class="dropdown-menu tg-dropdownusermenu" aria-labelledby="tg-dropdowndashboard">
										<li class="current-menu-item"><a href="dashboard.php">Dashboard</a></li>
								...
								<aside id="tg-sidebar" class="tg-sidebar">
									<div class="tg-widget tg-widgetdashboard">
										...
										<div class="tg-widgetcontent">
											<ul>
												<li class="selected"><a href="dashboard.php"><i class="icon-user"></i><span>Dashboard</span></a></li>
												<li><a href="my-profile.php"><i class="icon-pen2"></i><span>Edit Profile</span></a></li>
												<li><a href="change-password.php"><i class="icon-lock-open3"></i><span>Change Password</span></a></li>
												<li><a href="my-booking.php"><i class="icon-basket3"></i><span>My Booking</span></a></li>
												<li><a href="my-wish-list.php"><i class="icon-heart"></i><span>Wish List</span></a></li>
									...
									<div class="tg-dashboard">
										<div class="tg-box tg-profile">
											<div class="tg-heading">
												<h3>My Profile</h3>
												<a class="tg-btnedit" href="my-profile.php">Edit Profile</a>
											</div>
