...
<div class="container" style="width:100%;">
		<a href="tourbookingdetail.php" class="btn btn-info btn-lg" role="btn btn-warning">Move back to the site</a>
	<h2 align="center">Add  tour to the shopping Bag (1 per one person)</h2>
    <?php
	...
	if(!empty($_SESSION["cart"]))
	{
        ...
        <td><a href="billingdetail.php" class="btn btn-info" role="button">Move to paying process</a></td>
        </tr>
        <?php
	}
	?>
