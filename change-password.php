								...
								<aside id="tg-sidebar" class="tg-sidebar">
									<div class="tg-widget tg-widgetdashboard">
										...
										<div class="tg-widgetcontent">
											<ul>
												<li><a href="dashboard.php"><i class="icon-user"></i><span>Dashboard</span></a></li>
												<li><a href="my-profile.php"><i class="icon-pen2"></i><span>Edit Profile</span></a></li>
												<li class="selected"><a href="change-password.php"><i class="icon-lock-open3"></i><span>Change Password</span></a></li>
